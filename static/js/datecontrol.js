...
mvAry[mvAry.length] = ' <th align="left" width="1%"><svg id="prevMonth" class="icon" aria-hidden="true">\n' +
    '    <use xlink:href="#icon-houtui2"></use>\n' +
    '</svg></th>';
mvAry[mvAry.length] = ' <th align="center" width="98%" nowrap="nowrap"><select name="calendarYear" id="calendarYear" style="font-size:12px;"></select><select name="calendarMonth" id="calendarMonth" style="font-size:12px;"></select></th>';
mvAry[mvAry.length] = ' <th align="right" width="1%"><svg id="nextMonth" class="icon" aria-hidden="true">\n' +
...
mvAry[mvAry.length] = '<span class="txt_red" style="padding: 5px">:</span><select name="calendarMinute" id="calendarMinute"></select>';
mvAry[mvAry.length] = '<span class="txt_red" style="padding: 5px">:</span><select name="calendarSecond" id="calendarSecond"></select>';
...
document
.write('background-color: #FFFFFF;border: 1px solid #CCCCCC;width:300px;font-size:12px;margin-left:25px;"></div>');
/**if (document.all) {
document
